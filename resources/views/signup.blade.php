...
@section('content')
<div class="w-[100%] h-[86.5vh] md:h-[84.15vh] flex">
  <div class="md:w-1/2 w-full h-full px-16 md:px-40 py-16 text-[#f1f1f1] bg-[#111827]">
    ...
    <form>
      <div class="mb-4">
        ...
        <input class="w-full h-full mt-1 text-[#111827] text-[12px] rounded pl-[12px] py-2" type="text" name="username" placeholder="Username">
      </div>
      <div class="mb-4">
        <label class="capitalize text-[14px]">Full Name</label>
        <input class="w-full h-full mt-1 text-[#111827] text-[12px] rounded pl-[12px] py-2" type="text" name="fullname" placeholder="full name">
      </div>
      <div x-data="{ show: true }">
        <label class="capitalize text-[14px]">Password</label>
        <div class="relative">
          <input class="w-full h-full mt-1 text-[#111827] text-[12px] rounded pl-[12px] py-2" :type="show ? 'password' : 'text'"  name="password" placeholder="Password">
      ...
      <div class="my-4">
        ...
        <div class="relative">
          <select class="appearance-none w-full text-[#111827] text-[12px] py-2 px-[12px] pr-8 rounded">
